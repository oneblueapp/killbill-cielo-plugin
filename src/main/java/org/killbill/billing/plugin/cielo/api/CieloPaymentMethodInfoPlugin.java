...
public class CieloPaymentMethodInfoPlugin extends PluginPaymentMethodInfoPlugin {

    public CieloPaymentMethodInfoPlugin(final CieloPaymentMethodsRecord record) {
        super(UUID.fromString(record.getKbAccountId()),
              UUID.fromString(record.getKbPaymentMethodId()),
              record.getIsDefault() == CieloDao.TRUE,
              record.getToken());
    }
}
