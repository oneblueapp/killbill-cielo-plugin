...
package org.killbill.billing.plugin.cielo.client.model.paymentinfo;
...
public class Card extends PaymentInfo {
    ...
    public String getExpiryMonth() {
        return StringUtils.leftPad(expiryMonth.toString(), 2, "0");
    }
    ...
    public String getExpiryYear() {
        return StringUtils.leftPad(expiryYear.toString(), 2, "0");
    }
