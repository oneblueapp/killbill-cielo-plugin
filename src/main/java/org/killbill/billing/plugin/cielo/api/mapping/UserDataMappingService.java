...
package org.killbill.billing.plugin.cielo.api.mapping;
...
public abstract class UserDataMappingService {
    ...
    public static UserData toUserData(@Nullable final Account account, final Iterable<PluginProperty> properties) {
        ...
        final String propertyLocaleString = PluginProperties.findPluginPropertyValue(CieloPaymentPluginApi.PROPERTY_CUSTOMER_LOCALE, properties);
        ...
        // determine the email
        final String propertyEmail = PluginProperties.findPluginPropertyValue(CieloPaymentPluginApi.PROPERTY_EMAIL, properties);
        ...
        final String propertyFirstName = PluginProperties.findPluginPropertyValue(CieloPaymentPluginApi.PROPERTY_FIRST_NAME, properties);
        ...
        // determine last Name
        final String propertyLastName = PluginProperties.findPluginPropertyValue(CieloPaymentPluginApi.PROPERTY_LAST_NAME, properties);
        ...
        // set ip
        userData.setShopperIP(PluginProperties.findPluginPropertyValue(CieloPaymentPluginApi.PROPERTY_IP, properties));
