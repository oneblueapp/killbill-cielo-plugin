...
import static org.killbill.billing.plugin.cielo.api.CieloPaymentPluginApi.PROPERTY_CC_ISSUER_COUNTRY;
...
public abstract class CardMappingService {
    ...
    public static Card toPaymentInfo(final CieloPaymentMethodsRecord paymentMethodsRecord, final Iterable<PluginProperty> properties) {
