...
public abstract class BaseCieloPaymentServiceProviderPort {

    protected Logger logger;

    protected void logTransaction(final String transactionType, final UserData userData, final PaymentData paymentData, @Nullable final PurchaseResult result, @Nullable final CieloCallResult<?> ingenicoCall) {
    ...
    protected void logTransaction(final String transactionType, final String pspReference, final PaymentData paymentData, final PaymentModificationResponse response, final CieloCallResult<?> ingenicoCall) {
        final StringBuilder logBuffer = new StringBuilder();
        appendTransactionType(logBuffer, transactionType);
        appendPaymentData(logBuffer, paymentData);
    ...
    protected void logTransactionError(final String transactionType, final UserData userData, final PaymentData paymentData, final CieloCallResult<?> ingenicoCall) {
        final StringBuilder logBuffer = new StringBuilder();
        appendTransactionType(logBuffer, transactionType);
        appendPaymentData(logBuffer, paymentData);
        appendUserData(logBuffer, userData);
    ...
    protected void logTransactionError(final String transactionType, final String paymentId,  final PaymentData paymentData, final CieloCallResult<?> ingenicoCall) {
        final StringBuilder logBuffer = new StringBuilder();
        appendTransactionType(logBuffer, transactionType);
        appendPaymentData(logBuffer, paymentData);
    ...
    private void appendIngenicoCall(final StringBuilder buffer, final CieloCallResult<?> ingenicoCall) {
